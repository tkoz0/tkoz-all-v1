...
template <cNumberType T, long long n>
inline constexpr T cNumInteger = static_cast<T::FpType>(n);

/// A way to get rational constants dependent on floating point type.
template <cNumberType T, long long n, long long d>
inline constexpr T cNumRational =
    static_cast<T::FpType>(n) / static_cast<T::FpType>(d);
...
template <cNumberType T> inline constexpr T cNumEps;
template <> inline constexpr Fp32 cNumEps<Fp32> = 1.19209290e-7f;
template <> inline constexpr Fp64 cNumEps<Fp64> = 2.2204460492503131e-16;
...
template <cNumberType T, bool cSignalingT = false> inline constexpr T cNumNan;
template <cNumberType T>
inline constexpr T cNumNan<T, false> =
    std::numeric_limits<typename T::FpType>::quiet_NaN();
template <cNumberType T>
inline constexpr T cNumNan<T, true> =
    std::numeric_limits<typename T::FpType>::signaling_NaN();
...
template <cNumberType T>
inline constexpr T cNumInf =
    std::numeric_limits<typename T::FpType>::infinity();

/// Maximum finite value.
template <cNumberType T>
inline constexpr T cNumMax = std::numeric_limits<typename T::FpType>::max();

/// Minimum finite value.
template <cNumberType T>
inline constexpr T cNumMin = std::numeric_limits<typename T::FpType>::min();
...
template <cNumberType T> inline constexpr T cNumE;
template <> inline constexpr Fp32 cNumE<Fp32> = 2.7182818f;
template <> inline constexpr Fp64 cNumE<Fp64> = 2.718281828459045;
...
template <cNumberType T> inline constexpr T cNumPi;
template <> inline constexpr Fp32 cNumPi<Fp32> = 3.1415927f;
template <> inline constexpr Fp64 cNumPi<Fp64> = 3.141592653589793;
...
template <cNumberType T, int n, int d> inline constexpr T cNumPiMult;
// pi * 1/1 = 3.1415926535 8979323846 2643383279 5028841971 6939937510 ...
// bits (IEEE-754): float = +0x1.921fb6p+1f, double = +0x1.921fb54442d18p+1
template <> inline constexpr Fp32 cNumPiMult<Fp32, 1, 1> = 3.1415927f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 1, 1> = 3.141592653589793;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 2, 1> = 6.2831853f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 2, 1> = 6.283185307179586;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 1, 2> = 1.57079633f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 1, 2> = 1.5707963267948966;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 3, 2> = 4.712389f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 3, 2> = 4.71238898038469;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 1, 3> = 1.0471976f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 1, 3> = 1.04719755119659775;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 2, 3> = 2.0943951f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 2, 3> = 2.0943951023931955;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 4, 3> = 4.1887902f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 4, 3> = 4.188790204786391;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 5, 3> = 5.2359878f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 5, 3> = 5.235987755982989;
// pi * 1/4 = 0.7853981633 9744830961 5660845819 8757210492 9234984377 ...
// bits (IEEE-754): float = +0x1.921fb6p-1f, double = +0x1.921fb54442d18p-1
template <> inline constexpr Fp32 cNumPiMult<Fp32, 1, 4> = 0.7853982f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 1, 4> = 0.7853981633974483;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 3, 4> = 2.3561945f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 3, 4> = 2.356194490192345;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 5, 4> = 3.9269908f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 5, 4> = 3.9269908169872415;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 7, 4> = 5.497787f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 7, 4> = 5.497787143782138;
// pi * 1/6 = 0.5235987755 9829887307 7107230546 5838140328 6156656251 ...
// bits (IEEE-754): float = +0x1.0c1524p-1f, double = +0x1.0c152382d7366p-1
template <> inline constexpr Fp32 cNumPiMult<Fp32, 1, 6> = 0.5235988f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 1, 6> = 0.523598775598298873;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 5, 6> = 2.6179939f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 5, 6> = 2.6179938779914944;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 7, 6> = 3.6651914f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 7, 6> = 3.6651914291880921;
...
template <> inline constexpr Fp32 cNumPiMult<Fp32, 11, 6> = 5.7595865f;
template <> inline constexpr Fp64 cNumPiMult<Fp64, 11, 6> = 5.759586531581288;

// === Rational multiples of inverse pi ===
// reciprocals of the pi multiples

/// Multiples of 1/pi (n/(d*pi)) hardcoded to closest IEEE values
template <cNumberType T, int n, int d> inline constexpr T cNumInvPiMult;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 1, 1> = 0.318309886f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 1, 1> = 0.3183098861837907;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 1, 2> = 0.15915494f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 1, 2> = 0.15915494309189534;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 2, 1> = 0.63661977f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 2, 1> = 0.63661977236758134;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 2, 3> = 0.21220659f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 2, 3> = 0.212206590789193781;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 3, 1> = 0.95492966f;
template <> inline constexpr Fp64 cNumInvPiMult<Fp64, 3, 1> = 0.954929658551372;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 3, 2> = 0.47746483f;
template <> inline constexpr Fp64 cNumInvPiMult<Fp64, 3, 2> = 0.477464829275686;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 3, 4> = 0.23873241f;
template <> inline constexpr Fp64 cNumInvPiMult<Fp64, 3, 4> = 0.238732414637843;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 3, 5> = 0.19098593f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 3, 5> = 0.1909859317102744;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 4, 1> = 1.2732395f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 4, 1> = 1.2732395447351627;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 4, 3> = 0.42441318f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 4, 3> = 0.424413181578387562;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 4, 5> = 0.2546479f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 4, 5> = 0.25464790894703254;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 4, 7> = 0.18189136f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 4, 7> = 0.18189136353359467;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 6, 1> = 1.9098593f;
template <> inline constexpr Fp64 cNumInvPiMult<Fp64, 6, 1> = 1.909859317102744;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 6, 5> = 0.38197186f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 6, 5> = 0.3819718634205488;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 6, 7> = 0.27283705f;
template <> inline constexpr Fp64 cNumInvPiMult<Fp64, 6, 7> = 0.272837045300392;
...
template <> inline constexpr Fp32 cNumInvPiMult<Fp32, 6, 11> = 0.17362357f;
template <>
inline constexpr Fp64 cNumInvPiMult<Fp64, 6, 11> = 0.17362357428206764;

// === Square roots of integers ===
// only below 25 for now

/// Square root of an integer. Currently non perfect squares below 25
template <cNumberType T, int n> inline constexpr T cNumSqrt;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 2> = 1.41421356f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 2> = 1.41421356237309505;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 3> = 1.7320508f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 3> = 1.7320508075688773;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 5> = 2.236068f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 5> = 2.23606797749979;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 6> = 2.44948974f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 6> = 2.449489742783178;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 7> = 2.6457513f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 7> = 2.6457513110645906;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 8> = 2.828427f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 8> = 2.8284271247461901;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 10> = 3.1622777f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 10> = 3.16227766016837933;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 11> = 3.3166248f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 11> = 3.3166247903554;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 12> = 3.4641016f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 12> = 3.4641016151377546;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 13> = 3.6055513f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 13> = 3.605551275463989;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 14> = 3.7416574f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 14> = 3.7416573867739414;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 15> = 3.87298335f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 15> = 3.872983346207417;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 17> = 4.1231056f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 17> = 4.123105625617661;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 18> = 4.2426407f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 18> = 4.242640687119285;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 19> = 4.358899f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 19> = 4.358898943540674;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 20> = 4.472136f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 20> = 4.4721359549995794;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 21> = 4.582576f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 21> = 4.58257569495584;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 22> = 4.690416f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 22> = 4.69041575982343;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 23> = 4.7958315f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 23> = 4.7958315233127195;
...
template <> inline constexpr Fp32 cNumSqrt<Fp32, 24> = 4.8989795f;
template <> inline constexpr Fp64 cNumSqrt<Fp64, 24> = 4.898979485566356;

// === Inverse square roots of integers ===
// only below 25 for now

/// Inverse square root of an integer. Currently non perfect squares below 25
template <cNumberType T, int n> inline constexpr T cNumInvSqrt;
// 1/sqrt(n) = 0.7071067811 8654752440 0844362104 8490392848 3593768847 ...
// bits (IEEE-754): float = +0x1.6a09e6p-1f, double = +0x1.6a09e667f3bcdp-1
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 2> = 0.70710678f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 2> = 0.70710678118654752;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 3> = 0.57735027f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 3> = 0.57735026918962576;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 5> = 0.4472136f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 5> = 0.4472135954999579;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 6> = 0.4082482905f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 6> = 0.408248290463863;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 7> = 0.37796447f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 7> = 0.37796447300922723;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 8> = 0.35355339f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 8> = 0.3535533905932738;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 10> = 0.31622777f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 10> = 0.31622776601683793;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 11> = 0.30151134f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 11> = 0.30151134457776362;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 12> = 0.28867513f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 12> = 0.28867513459481288;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 13> = 0.2773501f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 13> = 0.2773500981126146;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 14> = 0.26726124f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 14> = 0.2672612419124244;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 15> = 0.2581989f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 15> = 0.25819888974716113;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 17> = 0.242535625f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 17> = 0.24253562503633297;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 18> = 0.23570226f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 18> = 0.23570226039551584;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 19> = 0.22941573f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 19> = 0.22941573387056177;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 20> = 0.2236068f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 20> = 0.22360679774997897;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 21> = 0.2182179f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 21> = 0.2182178902359924;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 22> = 0.21320072f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 22> = 0.21320071635561043;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 23> = 0.2085144f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 23> = 0.20851441405707476;
...
template <> inline constexpr Fp32 cNumInvSqrt<Fp32, 24> = 0.20412414523f;
template <> inline constexpr Fp64 cNumInvSqrt<Fp64, 24> = 0.2041241452319315;

// === Cube roots of integers ===
// only below 27 for now

/// Cube root of an integer. Currently non perfect cubes below 25
template <cNumberType T, int n> inline constexpr T cNumCbrt;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 2> = 1.25992105f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 2> = 1.2599210498948732;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 3> = 1.44224957f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 3> = 1.4422495703074084;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 4> = 1.58740105f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 4> = 1.587401051968199475;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 5> = 1.709976f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 5> = 1.709975946676697;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 6> = 1.8171206f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 6> = 1.8171205928321397;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 7> = 1.9129312f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 7> = 1.9129311827723891;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 9> = 2.0800838f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 9> = 2.080083823051904;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 10> = 2.1544347f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 10> = 2.154434690031884;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 11> = 2.2239801f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 11> = 2.2239800905693155;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 12> = 2.2894285f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 12> = 2.2894284851066637;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 13> = 2.35133469f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 13> = 2.3513346877207575;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 14> = 2.4101423f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 14> = 2.41014226417523;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 15> = 2.466212f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 15> = 2.4662120743304701;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 16> = 2.5198421f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 16> = 2.5198420997897463;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 17> = 2.5712816f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 17> = 2.57128159065823536;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 18> = 2.6207414f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 18> = 2.6207413942088966;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 19> = 2.6684016f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 19> = 2.668401648721945;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 20> = 2.7144176f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 20> = 2.7144176165949066;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 21> = 2.7589242f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 21> = 2.7589241763811207;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 22> = 2.8020393f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 22> = 2.8020393306553871;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 23> = 2.843867f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 23> = 2.8438669798515655;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 24> = 2.884499f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 24> = 2.8844991406148168;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 25> = 2.9240177f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 25> = 2.924017738212866;
...
template <> inline constexpr Fp32 cNumCbrt<Fp32, 26> = 2.962496f;
template <> inline constexpr Fp64 cNumCbrt<Fp64, 26> = 2.9624960684073705;

// === Inverse cube roots of integers ===
// only below 27 for now

/// Inverse cube root of an integer. Currently non perfect cubes below 25
template <cNumberType T, int n> inline constexpr T cNumInvCbrt;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 2> = 0.7937005f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 2> = 0.79370052598409974;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 3> = 0.6933613f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 3> = 0.6933612743506347;
// 1/cbrt(n) = 0.6299605249 4743658238 3605303639 1141752851 2573235075 ...
// bits (IEEE-754): float = +0x1.428a30p-1f, double = +0x1.428a2f98d728bp-1
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 4> = 0.62996052f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 4> = 0.6299605249474366;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 5> = 0.5848035f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 5> = 0.5848035476425732;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 6> = 0.5503212f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 6> = 0.55032120814910445;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 7> = 0.52275796f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 7> = 0.5227579585747102;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 9> = 0.48074986f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 9> = 0.4807498567691361;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 10> = 0.4641589f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 10> = 0.46415888336127789;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 11> = 0.449644313f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 11> = 0.44964431302260917;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 12> = 0.43679023f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 12> = 0.43679023236814943;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 13> = 0.42529037f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 13> = 0.42529037028299016;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 14> = 0.41491327f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 14> = 0.41491326668312172;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 15> = 0.405480133f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 15> = 0.40548013303822668;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 16> = 0.39685026f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 16> = 0.3968502629920499;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 17> = 0.38891112f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 17> = 0.3889111187328203;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 18> = 0.3815714f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 18> = 0.38157141418444396;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 19> = 0.3747562f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 19> = 0.37475617678431546;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 20> = 0.36840315f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 20> = 0.36840314986403866;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 21> = 0.362460124f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 21> = 0.36246012433429738;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 22> = 0.35688293f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 22> = 0.3568829277518041;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 23> = 0.35163389f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 23> = 0.3516338869169593;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 24> = 0.34668064f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 24> = 0.34668063717531735;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 25> = 0.34199519f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 25> = 0.3419951893353394;
...
template <> inline constexpr Fp32 cNumInvCbrt<Fp32, 26> = 0.3375532f;
template <> inline constexpr Fp64 cNumInvCbrt<Fp64, 26> = 0.33755319058958183;
