...
template <typename T> static constexpr T cNumEps;
template <> constexpr float cNumEps<float> = 1.19209290e-7f;
template <> constexpr double cNumEps<double> = 2.2204460492503131e-16;
...
template <typename T> static constexpr T cNumE;
template <> constexpr float cNumE<float> = 2.7182818f;
template <> constexpr double cNumE<double> = 2.718281828459045;
...
template <typename T> static constexpr T cNumPi;
template <> constexpr float cNumPi<float> = 3.1415927f;
...
template <> constexpr double cNumPiMult<double, 1, 3> = 1.04719755119659775;
...
template <> constexpr double cNumPiMult<double, 1, 4> = 0.7853981633974483;
...
template <> constexpr double cNumPiMult<double, 1, 6> = 0.523598775598298873;
...
template <typename T, int n> static constexpr T cNumSqrt;
...
template <> constexpr float cNumSqrt<float, 2> = 1.41421356f;
template <> constexpr double cNumSqrt<double, 2> = 1.41421356237309505;
...
template <> constexpr float cNumSqrt<float, 3> = 1.7320508f;
template <> constexpr double cNumSqrt<double, 3> = 1.7320508075688773;
...
template <> constexpr float cNumSqrt<float, 5> = 2.236068f;
template <> constexpr double cNumSqrt<double, 5> = 2.23606797749979;
...
template <> constexpr float cNumSqrt<float, 6> = 2.44948974f;
template <> constexpr double cNumSqrt<double, 6> = 2.449489742783178;
...
template <> constexpr float cNumSqrt<float, 7> = 2.6457513f;
template <> constexpr double cNumSqrt<double, 7> = 2.6457513110645906;
...
template <> constexpr float cNumSqrt<float, 8> = 2.828427f;
template <> constexpr double cNumSqrt<double, 8> = 2.8284271247461901;
...
template <> constexpr float cNumSqrt<float, 10> = 3.1622777f;
template <> constexpr double cNumSqrt<double, 10> = 3.16227766016837933;
...
template <> constexpr float cNumSqrt<float, 11> = 3.3166248f;
template <> constexpr double cNumSqrt<double, 11> = 3.3166247903554;
...
template <> constexpr float cNumSqrt<float, 12> = 3.4641016f;
template <> constexpr double cNumSqrt<double, 12> = 3.4641016151377546;
...
template <> constexpr float cNumSqrt<float, 13> = 3.6055513f;
template <> constexpr double cNumSqrt<double, 13> = 3.605551275463989;
...
template <> constexpr float cNumSqrt<float, 14> = 3.7416574f;
template <> constexpr double cNumSqrt<double, 14> = 3.7416573867739414;
...
template <> constexpr float cNumSqrt<float, 15> = 3.87298335f;
template <> constexpr double cNumSqrt<double, 15> = 3.872983346207417;
...
template <> constexpr float cNumSqrt<float, 17> = 4.1231056f;
template <> constexpr double cNumSqrt<double, 17> = 4.123105625617661;
...
template <> constexpr float cNumSqrt<float, 18> = 4.2426407f;
template <> constexpr double cNumSqrt<double, 18> = 4.242640687119285;
...
template <> constexpr float cNumSqrt<float, 19> = 4.358899f;
template <> constexpr double cNumSqrt<double, 19> = 4.358898943540674;
...
template <> constexpr float cNumSqrt<float, 20> = 4.472136f;
template <> constexpr double cNumSqrt<double, 20> = 4.4721359549995794;
...
template <> constexpr float cNumSqrt<float, 21> = 4.582576f;
template <> constexpr double cNumSqrt<double, 21> = 4.58257569495584;
...
template <> constexpr float cNumSqrt<float, 22> = 4.690416f;
template <> constexpr double cNumSqrt<double, 22> = 4.69041575982343;
...
template <> constexpr float cNumSqrt<float, 23> = 4.7958315f;
template <> constexpr double cNumSqrt<double, 23> = 4.7958315233127195;
...
template <> constexpr float cNumSqrt<float, 24> = 4.8989795f;
template <> constexpr double cNumSqrt<double, 24> = 4.898979485566356;

// === Inverse square roots of integers ===
// only below 25 for now

/// Inverse square root of an integer. Currently non perfect squares below 25
template <typename T, int n> static constexpr T cNumInvSqrt;
// 1/sqrt(n) = 0.7071067811 8654752440 0844362104 8490392848 3593768847 ...
// bits (IEEE-754): float = +0x1.6a09e6p-1f, double = +0x1.6a09e667f3bcdp-1
template <> constexpr float cNumInvSqrt<float, 2> = 0.70710678f;
template <> constexpr double cNumInvSqrt<double, 2> = 0.70710678118654752;
...
template <> constexpr float cNumInvSqrt<float, 3> = 0.57735027f;
template <> constexpr double cNumInvSqrt<double, 3> = 0.57735026918962576;
...
template <> constexpr float cNumInvSqrt<float, 5> = 0.4472136f;
template <> constexpr double cNumInvSqrt<double, 5> = 0.4472135954999579;
...
template <> constexpr float cNumInvSqrt<float, 6> = 0.4082482905f;
template <> constexpr double cNumInvSqrt<double, 6> = 0.408248290463863;
...
template <> constexpr float cNumInvSqrt<float, 7> = 0.37796447f;
template <> constexpr double cNumInvSqrt<double, 7> = 0.37796447300922723;
...
template <> constexpr float cNumInvSqrt<float, 8> = 0.35355339f;
template <> constexpr double cNumInvSqrt<double, 8> = 0.3535533905932738;
...
template <> constexpr float cNumInvSqrt<float, 10> = 0.31622777f;
template <> constexpr double cNumInvSqrt<double, 10> = 0.31622776601683793;
...
template <> constexpr float cNumInvSqrt<float, 11> = 0.30151134f;
template <> constexpr double cNumInvSqrt<double, 11> = 0.30151134457776362;
...
template <> constexpr float cNumInvSqrt<float, 12> = 0.28867513f;
template <> constexpr double cNumInvSqrt<double, 12> = 0.28867513459481288;
...
template <> constexpr float cNumInvSqrt<float, 13> = 0.2773501f;
template <> constexpr double cNumInvSqrt<double, 13> = 0.2773500981126146;
...
template <> constexpr float cNumInvSqrt<float, 14> = 0.26726124f;
template <> constexpr double cNumInvSqrt<double, 14> = 0.2672612419124244;
...
template <> constexpr float cNumInvSqrt<float, 15> = 0.2581989f;
template <> constexpr double cNumInvSqrt<double, 15> = 0.25819888974716113;
...
template <> constexpr float cNumInvSqrt<float, 17> = 0.242535625f;
template <> constexpr double cNumInvSqrt<double, 17> = 0.24253562503633297;
...
template <> constexpr float cNumInvSqrt<float, 18> = 0.23570226f;
template <> constexpr double cNumInvSqrt<double, 18> = 0.23570226039551584;
...
template <> constexpr float cNumInvSqrt<float, 19> = 0.22941573f;
template <> constexpr double cNumInvSqrt<double, 19> = 0.22941573387056177;
...
template <> constexpr float cNumInvSqrt<float, 20> = 0.2236068f;
template <> constexpr double cNumInvSqrt<double, 20> = 0.22360679774997897;
...
template <> constexpr float cNumInvSqrt<float, 21> = 0.2182179f;
template <> constexpr double cNumInvSqrt<double, 21> = 0.2182178902359924;
...
template <> constexpr float cNumInvSqrt<float, 22> = 0.21320072f;
template <> constexpr double cNumInvSqrt<double, 22> = 0.21320071635561043;
...
template <> constexpr float cNumInvSqrt<float, 23> = 0.2085144f;
template <> constexpr double cNumInvSqrt<double, 23> = 0.20851441405707476;
...
template <> constexpr float cNumInvSqrt<float, 24> = 0.20412414523f;
template <> constexpr double cNumInvSqrt<double, 24> = 0.2041241452319315;

// === Cube roots of integers ===
// only below 27 for now

/// Cube root of an integer. Currently non perfect cubes below 25
template <typename T, int n> static constexpr T cNumCbrt;
...
template <> constexpr float cNumCbrt<float, 2> = 1.25992105f;
template <> constexpr double cNumCbrt<double, 2> = 1.2599210498948732;
...
template <> constexpr float cNumCbrt<float, 3> = 1.44224957f;
template <> constexpr double cNumCbrt<double, 3> = 1.4422495703074084;
...
template <> constexpr float cNumCbrt<float, 4> = 1.58740105f;
template <> constexpr double cNumCbrt<double, 4> = 1.587401051968199475;
...
template <> constexpr float cNumCbrt<float, 5> = 1.709976f;
template <> constexpr double cNumCbrt<double, 5> = 1.709975946676697;
...
template <> constexpr float cNumCbrt<float, 6> = 1.8171206f;
template <> constexpr double cNumCbrt<double, 6> = 1.8171205928321397;
...
template <> constexpr float cNumCbrt<float, 7> = 1.9129312f;
template <> constexpr double cNumCbrt<double, 7> = 1.9129311827723891;
...
template <> constexpr float cNumCbrt<float, 9> = 2.0800838f;
template <> constexpr double cNumCbrt<double, 9> = 2.080083823051904;
...
template <> constexpr float cNumCbrt<float, 10> = 2.1544347f;
template <> constexpr double cNumCbrt<double, 10> = 2.154434690031884;
...
template <> constexpr float cNumCbrt<float, 11> = 2.2239801f;
template <> constexpr double cNumCbrt<double, 11> = 2.2239800905693155;
...
template <> constexpr float cNumCbrt<float, 12> = 2.2894285f;
template <> constexpr double cNumCbrt<double, 12> = 2.2894284851066637;
...
template <> constexpr float cNumCbrt<float, 13> = 2.35133469f;
template <> constexpr double cNumCbrt<double, 13> = 2.3513346877207575;
...
template <> constexpr float cNumCbrt<float, 14> = 2.4101423f;
template <> constexpr double cNumCbrt<double, 14> = 2.41014226417523;
...
template <> constexpr float cNumCbrt<float, 15> = 2.466212f;
template <> constexpr double cNumCbrt<double, 15> = 2.4662120743304701;
...
template <> constexpr float cNumCbrt<float, 16> = 2.5198421f;
template <> constexpr double cNumCbrt<double, 16> = 2.5198420997897463;
...
template <> constexpr float cNumCbrt<float, 17> = 2.5712816f;
template <> constexpr double cNumCbrt<double, 17> = 2.57128159065823536;
...
template <> constexpr float cNumCbrt<float, 18> = 2.6207414f;
template <> constexpr double cNumCbrt<double, 18> = 2.6207413942088966;
...
template <> constexpr float cNumCbrt<float, 19> = 2.6684016f;
template <> constexpr double cNumCbrt<double, 19> = 2.668401648721945;
...
template <> constexpr float cNumCbrt<float, 20> = 2.7144176f;
template <> constexpr double cNumCbrt<double, 20> = 2.7144176165949066;
...
template <> constexpr float cNumCbrt<float, 21> = 2.7589242f;
template <> constexpr double cNumCbrt<double, 21> = 2.7589241763811207;
...
template <> constexpr float cNumCbrt<float, 22> = 2.8020393f;
template <> constexpr double cNumCbrt<double, 22> = 2.8020393306553871;
...
template <> constexpr float cNumCbrt<float, 23> = 2.843867f;
template <> constexpr double cNumCbrt<double, 23> = 2.8438669798515655;
...
template <> constexpr float cNumCbrt<float, 24> = 2.884499f;
template <> constexpr double cNumCbrt<double, 24> = 2.8844991406148168;
...
template <> constexpr float cNumCbrt<float, 25> = 2.9240177f;
template <> constexpr double cNumCbrt<double, 25> = 2.924017738212866;
...
template <> constexpr float cNumCbrt<float, 26> = 2.962496f;
template <> constexpr double cNumCbrt<double, 26> = 2.9624960684073705;

// === Inverse cube roots of integers ===
// only below 27 for now

/// Inverse cube root of an integer. Currently non perfect cubes below 25
template <typename T, int n> static constexpr T cNumInvCbrt;
...
template <> constexpr float cNumInvCbrt<float, 2> = 0.7937005f;
template <> constexpr double cNumInvCbrt<double, 2> = 0.79370052598409974;
...
template <> constexpr float cNumInvCbrt<float, 3> = 0.6933613f;
template <> constexpr double cNumInvCbrt<double, 3> = 0.6933612743506347;
// 1/cbrt(n) = 0.6299605249 4743658238 3605303639 1141752851 2573235075 ...
// bits (IEEE-754): float = +0x1.428a30p-1f, double = +0x1.428a2f98d728bp-1
template <> constexpr float cNumInvCbrt<float, 4> = 0.62996052f;
template <> constexpr double cNumInvCbrt<double, 4> = 0.6299605249474366;
...
template <> constexpr float cNumInvCbrt<float, 5> = 0.5848035f;
template <> constexpr double cNumInvCbrt<double, 5> = 0.5848035476425732;
...
template <> constexpr float cNumInvCbrt<float, 6> = 0.5503212f;
template <> constexpr double cNumInvCbrt<double, 6> = 0.55032120814910445;
...
template <> constexpr float cNumInvCbrt<float, 7> = 0.52275796f;
template <> constexpr double cNumInvCbrt<double, 7> = 0.5227579585747102;
...
template <> constexpr float cNumInvCbrt<float, 9> = 0.48074986f;
template <> constexpr double cNumInvCbrt<double, 9> = 0.4807498567691361;
...
template <> constexpr float cNumInvCbrt<float, 10> = 0.4641589f;
template <> constexpr double cNumInvCbrt<double, 10> = 0.46415888336127789;
...
template <> constexpr float cNumInvCbrt<float, 11> = 0.449644313f;
template <> constexpr double cNumInvCbrt<double, 11> = 0.44964431302260917;
...
template <> constexpr float cNumInvCbrt<float, 12> = 0.43679023f;
template <> constexpr double cNumInvCbrt<double, 12> = 0.43679023236814943;
...
template <> constexpr float cNumInvCbrt<float, 13> = 0.42529037f;
template <> constexpr double cNumInvCbrt<double, 13> = 0.42529037028299016;
...
template <> constexpr float cNumInvCbrt<float, 14> = 0.41491327f;
template <> constexpr double cNumInvCbrt<double, 14> = 0.41491326668312172;
...
template <> constexpr float cNumInvCbrt<float, 15> = 0.405480133f;
template <> constexpr double cNumInvCbrt<double, 15> = 0.40548013303822668;
...
template <> constexpr float cNumInvCbrt<float, 16> = 0.39685026f;
template <> constexpr double cNumInvCbrt<double, 16> = 0.3968502629920499;
...
template <> constexpr float cNumInvCbrt<float, 17> = 0.38891112f;
template <> constexpr double cNumInvCbrt<double, 17> = 0.3889111187328203;
...
template <> constexpr float cNumInvCbrt<float, 18> = 0.3815714f;
template <> constexpr double cNumInvCbrt<double, 18> = 0.38157141418444396;
...
template <> constexpr float cNumInvCbrt<float, 19> = 0.3747562f;
template <> constexpr double cNumInvCbrt<double, 19> = 0.37475617678431546;
...
template <> constexpr float cNumInvCbrt<float, 20> = 0.36840315f;
template <> constexpr double cNumInvCbrt<double, 20> = 0.36840314986403866;
...
template <> constexpr float cNumInvCbrt<float, 21> = 0.362460124f;
template <> constexpr double cNumInvCbrt<double, 21> = 0.36246012433429738;
...
template <> constexpr float cNumInvCbrt<float, 22> = 0.35688293f;
template <> constexpr double cNumInvCbrt<double, 22> = 0.3568829277518041;
...
template <> constexpr float cNumInvCbrt<float, 23> = 0.35163389f;
template <> constexpr double cNumInvCbrt<double, 23> = 0.3516338869169593;
...
template <> constexpr float cNumInvCbrt<float, 24> = 0.34668064f;
template <> constexpr double cNumInvCbrt<double, 24> = 0.34668063717531735;
...
template <> constexpr float cNumInvCbrt<float, 25> = 0.34199519f;
template <> constexpr double cNumInvCbrt<double, 25> = 0.3419951893353394;
...
template <> constexpr float cNumInvCbrt<float, 26> = 0.3375532f;
template <> constexpr double cNumInvCbrt<double, 26> = 0.33755319058958183;
